...
const dict = {
  en: {
    ...
    nav: {
      ...
      events: "Events", scholarships: "Scholarships", about: "About", admin: "Admin",
    },
    ...
    home: {
      ...
      serviceCards: [
        ...
        { title: "Scholarships", desc: "Merit and need-based aid for school, college and higher studies." },
    ...
    scholarships: {
      title: "Scholarships",
      subtitle: "Educational support for school, college and higher studies for deserving Nadar students from Coimbatore.",
      eligibility: "Eligibility",
      eligibilityCriteria: [
        "Student or parent must be a registered sangam member.",
        "Hindu or Christian Nadar community, residing in Coimbatore district.",
        "Minimum 75% marks for merit aid · annual family income below ₹3,00,000 for need-based aid.",
        "Valid bonafide certificate from school / college.",
      ],
      applicationStatus: "Application status",
      applicationStatusSub: "Track your application here once submitted.",
      steps: ["Submitted", "Documents verified", "Committee review", "Approved & Disbursed"],
      advanceDemo: "Advance status (demo)",
      applyNow: "Apply now",
      fields: {
        ...
        documents: "Upload documents (mark sheet, income certificate, bonafide)",
      },
      submit: "Submit application",
      submitToast: "Application submitted. We'll verify documents within 7 days.",
    },
    ...
    about: {
      ...
      historyP2: "We welcome both Hindu and Christian Nadar families. Our work spans matrimony, educational scholarships, health camps, business networking and emergency welfare. Every initiative is funded by member contributions and run by volunteer office bearers elected every three years.",
    ...
    admin: {
      ...
      pendingScholarships: "Pending Scholarships",
  ...
  ta: {
    ...
    nav: {
      ...
      events: "நிகழ்வுகள்", scholarships: "உதவித்தொகை", about: "எங்களைப் பற்றி", admin: "நிர்வாகம்",
    },
    ...
    home: {
      ...
      serviceCards: [
        ...
        { title: "உதவித்தொகை", desc: "பள்ளி, கல்லூரி மற்றும் உயர் கல்விக்கு தகுதி மற்றும் தேவை அடிப்படையிலான உதவி." },
    ...
    scholarships: {
      title: "உதவித்தொகை",
      subtitle: "கோயம்புத்தூரில் தகுதியான நாடார் மாணவர்களுக்கான பள்ளி, கல்லூரி மற்றும் உயர் கல்வி ஆதரவு.",
      eligibility: "தகுதி",
      eligibilityCriteria: [
        "மாணவர் அல்லது பெற்றோர் பதிவு செய்த சங்க உறுப்பினராக இருக்க வேண்டும்.",
        "கோயம்புத்தூர் மாவட்டத்தில் வசிக்கும் இந்து அல்லது கிறிஸ்தவ நாடார் சமூகத்தினர்.",
        "தகுதி உதவிக்கு குறைந்தபட்சம் 75% மதிப்பெண் · தேவை அடிப்படை உதவிக்கு ஆண்டு வருமானம் ₹3,00,000-க்கு கீழ்.",
        "பள்ளி / கல்லூரியிலிருந்து செல்லுபடியாகும் பயணச் சான்றிதழ்.",
      ],
      applicationStatus: "விண்ணப்ப நிலை",
      applicationStatusSub: "சமர்ப்பித்த பிறகு உங்கள் விண்ணப்பத்தை இங்கே கண்காணிக்கவும்.",
      steps: ["சமர்ப்பிக்கப்பட்டது", "ஆவணங்கள் சரிபார்க்கப்பட்டன", "குழு மதிப்பாய்வு", "அனுமதிக்கப்பட்டு வழங்கப்பட்டது"],
      advanceDemo: "நிலையை முன்னேற்றவும் (செயல்விளக்கம்)",
      applyNow: "இப்போது விண்ணப்பிக்கவும்",
      fields: {
        studentName: "மாணவர் பெயர் *",
        school: "பள்ளி / கல்லூரி *",
        marks: "சமீபத்திய மதிப்பெண்கள் (%)",
        income: "ஆண்டு குடும்ப வருமானம் (₹)",
        documents: "ஆவணங்களை பதிவேற்றவும் (மதிப்பெண் பட்டியல், வருமான சான்றிதழ், பயண சான்றிதழ்)",
      },
      submit: "விண்ணப்பத்தை சமர்ப்பிக்கவும்",
      submitToast: "விண்ணப்பம் சமர்ப்பிக்கப்பட்டது. 7 நாட்களுக்குள் ஆவணங்களை சரிபார்ப்போம்.",
    },
    ...
    admin: {
      ...
      pendingScholarships: "நிலுவையில் உள்ள உதவித்தொகைகள்",
