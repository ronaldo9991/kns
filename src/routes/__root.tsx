...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Official community portal of Kovai Nadar Sangam — matrimony, member directory, scholarships, events and business network for Hindu & Christian Nadar families of Coimbatore." },
      { property: "og:title", content: "Kovai Nadar Sangam — Community Trust, Coimbatore" },
      { property: "og:description", content: "Official community portal of Kovai Nadar Sangam — matrimony, member directory, scholarships, events and business network for Hindu & Christian Nadar families of Coimbatore." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Kovai Nadar Sangam — Community Trust, Coimbatore" },
      { name: "twitter:description", content: "Official community portal of Kovai Nadar Sangam — matrimony, member directory, scholarships, events and business network for Hindu & Christian Nadar families of Coimbatore." },
